...
function preload() {
	rkt = loadImage('rocket.png');
	rktpod = loadImage('rocketpod.png');
	rktshields = loadImage('shields.png');
	rktextra = loadImage('rocketbig.png');
	scr = loadImage('saucer.png');
	scrpod = loadImage('saucerpod.png');
	scrdest = loadImage('scrdestroyed.png');
}
